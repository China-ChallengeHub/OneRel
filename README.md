...
This repository contians the source code and datasets for the paper: **OneRel: Joint Entity and Relation Extraction with One Model in One Step**, Yu-Ming Shang, Heyan Huang and Xian-Ling Mao, AAAI-2020.
...
2. **The pre-trained BERT**
    ...
    If the network is available, the pre-trained BERT (bert-base-cased) will be downloaded automatically.
