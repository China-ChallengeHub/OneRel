...
parser.add_argument('--dataset', type=str, default='WebNLG_star')
...
parser.add_argument('--rel_num', type=int, default=171)
...
model_name = "OneRel_DATASET_WebNLG_star_LR_1e-05_BS_6Max_len100Bert_ML200DP_0.2proj_3_drop_2_9"
